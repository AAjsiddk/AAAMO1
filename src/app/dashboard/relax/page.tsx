...
import { collection, doc, serverTimestamp, query, addDoc, deleteDoc, Timestamp } from 'firebase/firestore';
...
import { PlusCircle, Trash2, Loader2, PartyPopper, Inbox } from 'lucide-react';
      ...
      <div className="flex items-center justify-between space-y-2">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle>نشاط ترفيهي جديد</DialogTitle>
            </DialogHeader>
            <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="مثال: الخروج مع الأصدقاء" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                 ...
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="مثال: اجتماعي, رياضي, سفر" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea placeholder="صف النشاط أو خطط له" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
         ...
         <Card>
           <CardContent className="flex flex-col items-center justify-center gap-4 p-16 text-center">
              ...
              <p className="text-muted-foreground max-w-md">
                ابدأ بإضافة نشاط تستمتع به أو خروجة تخطط لها.
              </p>
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                هذا الإجراء لا يمكن التراجع عنه. سيتم حذف هذا النشاط بشكل دائم.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                              <AlertDialogCancel>إلغاء</AlertDialogCancel>
                              <AlertDialogAction onClick={() => handleDeleteActivity(activity.id)}>متابعة</AlertDialogAction>
                            </AlertDialogFooter>
                          </AlertDialogContent>
                        </AlertDialog>
                    </CardTitle>
